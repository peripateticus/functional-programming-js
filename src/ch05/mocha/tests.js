...
describe('Chapter 5', function () {
	...
	it("Simple find with wrapper", function () {
	...
	it("Simple empty container", function () {
	...
	it("Maybe to extract a nested property in object graph", function () {
	...
	it("Maybe to extract a missing nested property in object graph", function () {
	...
	it("Simple Either monad test", function () {
	...
	it("Using Either in show Student", function () {
	...
	it("Monads as programmable commas", function () {
	...
	it("Complete showStudent program", function () {
