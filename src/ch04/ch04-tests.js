...
describe("Chapter 4", function () {
	...
	it("Chaining methods together", function () {
	...
	it("Extending the core language", function () {
		...
		assert.notStrictEqual(result, ['http://example.com', 'http', 'example', 'com']);
	});


	it("Compsition", function () {
	...
	it("Composition with functional libraries", function () {
		// Given data: 
	...
	it("Composition as point-free functions", function () {
		// Given data: 
		let students = ['Rosser', 'Turing', 'Kleene', 'Church'];
		let grades = [80, 100, 90, 99];
	...
	it("Show student program with currying and composition", function () {
	...
	it("More point-free coding", function () {
