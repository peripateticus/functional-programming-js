...
describe('Chapter 3', function () {
	it("Listing 1.1 Functional printMessage", function () {
	...
	it("Listing 1.2 Extending printMessage", function () {
		// The book uses the DOM to print. I'll use the console instead in Node. 
		// But it's the same mechanism
	...
	it("Listing 1.3 Imperative showStudent function with side effects", function () {
	...
	it("Listing 1.4 Decomposing the showStudent program", function () {
		// The book uses a mock storage object in chapter 1.
	...
	it("Listing 1.5 Programming with function chains", function () {
